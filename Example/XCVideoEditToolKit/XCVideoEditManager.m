...
- (void)startEditVideo:(NSURL *)videoUrl progress:(XCEditingProgressBlock)progressBlock success:(XCEditedSuccessBlock)successBlock failure:(XCEditedFailureBlock)failureBlock{
        // 1. 加载本地视频资源
        ...
        // 5. 导出编辑后的视频
        NSString *videoName = [NSString stringWithFormat:@"%f.MOV",[[NSDate date] timeIntervalSince1970]];
